...
---
## 담당 범위
> **Contribution:** 카메라 기준 이동·점프·회전,
> Follow Camera와 스킬 성공 시 Target 방향 전환 구현·검증
---
...
- 현재 입력 구조는 기존 Unity Input API 기준
- 전투 중 이동 제한, Lock-on, Root Motion은 포함하지 않음
- 경사면·낙하 등 복잡한 Ground 판정은 별도 보강 필요
- 입력과 이동 설정이 증가하면 Input System과 설정 데이터 분리 검토
